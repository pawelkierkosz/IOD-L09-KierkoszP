...
public class BFSProcessor {
     ...
     * Paweł Kierkosz
     * Zmieniłem kod dodajac negacje przy visitedNodes.contains i teraz sprawdzam czy sasiad nie zostal odwiedzony
    ...
    private List<Integer> getAllValidNeighbors(int nodeNo) {
        ...
        for (int i = 0; i < matrix.length; i++) {
            if (matrix[nodeNo][i] == 1 && !visitedNodes.contains(new Integer(i))) {
